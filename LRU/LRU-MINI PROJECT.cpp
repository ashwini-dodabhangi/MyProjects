...
output(200,500,"Hirasugar Institute Of Technology",2);
output(320,450," Nidasoshi ",2);
output(240,400,"Subject: Computer Graphics & Visualization Lab (18CSL67)",2);
output(280,300,"MINI PROJECT ON",2);

output(220,250,"Simulation of LRU using OpenGL",2);
output(100,150,"Guide:",3);
output(135,130,"Prof.S.G.Gollagi",5);

output(450,150,"By:",3);
output(475,130,"Girish G. Hiremath[2hn18cs008]",5);
output(475,100,"Geetanjali V. Patil[2hn18cs007]",5);
output(475,100,"Ashwini A. Dodabhangi[2hn18cs004]",5);
...
void display()
{
	...
	if(showresult && step==8)
	{
        ...
        drawText("DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING", 250, 550, 0);
		drawText("CGV MINI PROJECT : LRU Page Replacement Algorithm", 250, 550, 0);
		drawText("BY : ASHWINI(004), GEETANJALI(007), GIRISH(008)", 250, 550, 0);
		drawText("GUIDE : Prof. S.G.Gollagi (Ph.D)", 250, 550, 0);
	glFlush();
	glutSwapBuffers();
}
void idle()
